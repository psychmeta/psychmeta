...
.validate_corr_method <- function(correction_method, construct_x, construct_y) {
  if (is.matrix(correction_method)) {
    ...
    out <- list(correction_method <- scalar_arg_warning(arg = unlist(correction_method), arg_name = "correction_method"),
