---
title: "Barebones Meta-Analysis of Correlations"
author: "Brenton Wiernik"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{psychmeta barebones_correlations}
...
**psychmeta** assumes that your data are in "wide" format, with each row corresponding
...
function to reshape it. See also `vignette("pivot", "tidyr")`.
...
- **`rxyi`**, **`n`**, **`sample_id`**, and **`moderators`** are the names of the columns in your 
...
- **`CR_LL_95`** and **`CR_UL_95`** are the upper and lower bounds of the credibility 
